class Level2 extends Phaser.Scene {
    ...
    create() {
        ...
        bushes.create(600, 450, 'bush');
        bushes.create(1200, 350, 'bush');
        bushes.create(1400, 250, 'bush');
        bushes.create(2000, 450, 'bush');
