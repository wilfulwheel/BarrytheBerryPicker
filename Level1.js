class Level1 extends Phaser.Scene {
    ...
    create() {
        ...
        bushes.create(575, 450, 'bush');
        bushes.create(75, 325, 'bush');
        bushes.create(675, 200, 'bush');
        ...
        function collectBerry (player, berry) {
            ...
            score += 1;
            scoreText.setText(`Berries Collected: ${score}/7`);

            if (berries.countActive(true) === 0)
            {
                scoreText.setText(`Berries Collected: ${score}/7\nHarvest Complete!`);
                this.add.image(700, 100, 'sign');
                door.create(785, 115, 'door').setOrigin(0);
        ...
        //score
        let score = 0;
        let scoreText = this.add.text(25, 25, 'Berries Collected: 0/7', {fontSize: '20px', fill: '#000000'}).setScrollFactor(0);

        //bug
        gameState.bug = this.physics.add.sprite(400, 420, 'bug');
        ...
        this.physics.add.overlap(gameState.player, gameState.bug, () => {
            this.add.text(200, 200, 'Game Over...', {fontSize: '50px', fill: '#ff2e8b'});
            this.add.text(200, 250, 'Press spacebar to play again', {fontSize:'25px', fill: '#000000'})
